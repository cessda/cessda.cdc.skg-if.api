...
`open an issue <https://github.com/eoscbeyond/noderegistrydemo/issues/new>`_ in the
GitHub repository.
...
Always also comply to the `Code of Conduct <./CODE_OF_CONDUCT.md>`_ when contributing.

Commit Messages
~~~~~~~~~~~~~~~

Please follow the `Conventional Commits <https://www.conventionalcommits.org/en/v1.0.0/>`_
...
`CONTRIBUTORS.md <./CONTRIBUTORS.md>`_ and `CITATION.cff <./CITATION.cff>`_ files.
